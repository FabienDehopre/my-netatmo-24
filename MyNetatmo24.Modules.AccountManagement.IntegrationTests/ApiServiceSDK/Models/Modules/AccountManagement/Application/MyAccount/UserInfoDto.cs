...
namespace ApiServiceSDK.Models.Modules.AccountManagement.Application.MyAccount
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>The URL of the user&apos;s avatar, which may be null if the user has not set an avatar.</summary>
...
#nullable restore
        ...
        public string AvatarUrl { get; set; }
#endif
        /// <summary>The user&apos;s first name, which is required and cannot be null or empty.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string FirstName { get; set; }
#endif
        /// <summary>The user&apos;s last name, which is required and cannot be null or empty.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string LastName { get; set; }
#endif
        /// <summary>The user&apos;s nickname, which may be null if the user has not set a nickname.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
